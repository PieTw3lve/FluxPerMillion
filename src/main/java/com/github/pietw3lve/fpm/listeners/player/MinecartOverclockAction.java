...
public class MinecartOverclockAction implements EventActionUtil<PlayerInteractEvent> {
    ...
    public void execute(PlayerInteractEvent event) {
        ...
        FluxLevelChangeEvent fluxEvent = new FluxLevelChangeEvent(plugin.getFluxMeter(), player.getLocation(), player, null, "overclocked", "minecart", points, ActionCategory.ENERGY);
