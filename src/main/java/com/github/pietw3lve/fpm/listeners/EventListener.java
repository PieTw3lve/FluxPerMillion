...
import com.github.pietw3lve.fpm.listeners.block.CoalPlaceAction;
...
public class EventListener implements Listener {
    ...
    public EventListener(FluxPerMillion plugin) {
        ...
        actions.put(BlockPlaceEvent.class, new ArrayList<>(Arrays.asList(new PlaceMetadataSetAction(plugin), new CampfirePlaceAction(plugin), new CoalPlaceAction(plugin), new TorchPlaceAction(plugin), new FirePlaceAction(plugin))));
        ...
        actions.put(PlayerInteractEvent.class, new ArrayList<>(Arrays.asList(new ComposterAction(plugin), new ElytraBoostAction(plugin), new FireworkLaunchAction(plugin), new TreeStripAction(plugin), new MinecartBoostAction(plugin), new MinecartOverclockAction(plugin))));
