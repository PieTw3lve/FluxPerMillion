...
public class FlowerPlaceAction implements EventActionUtil<BlockPlaceEvent> {
    ...
    public FlowerPlaceAction(FluxPerMillion plugin) {
        this.plugin = plugin;
    ...
    public void execute(BlockPlaceEvent event) {
        ...
        double points = plugin.getConfig().getDouble(FLUX_POINTS_FLOWER_PLACE);
