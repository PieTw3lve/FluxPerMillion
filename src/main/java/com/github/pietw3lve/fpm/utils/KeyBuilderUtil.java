...
public class KeyBuilderUtil implements Cloneable {

    private final FileConfiguration config;
    private final char separator;
    private final StringBuilder builder;

    public KeyBuilderUtil(FileConfiguration config, char separator) {
        this.config = config;
        this.separator = separator;
        this.builder = new StringBuilder();
    }

    private KeyBuilderUtil(KeyBuilderUtil keyBuilder) {
    ...
    @Override
    protected KeyBuilderUtil clone() {
        return new KeyBuilderUtil(this);
    }
}